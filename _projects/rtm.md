...
title: "Review-through-Making: Developing a Tangible Vocabulary of Data Physicalization"


cover: /assets/img/RtM_Cover.jpg

project_type: Individual MSc Research Project

publication: "Manuscript as Pictorial under review (collaborated with supervisors: Steven Houben, Hans Brombacher)"
...
gallery:
  - src: /assets/img/RtM/RtM-01.png
    alt: Review Process

  - src: /assets/img/RtM/RtM-02.png
    alt: Archetype (1/2)

  - src: /assets/img/RtM/RtM-03.png
    alt: Archetype (2/2)

  - src: /assets/img/RtM/RtM-04.png
    alt: Vocabulary

  - src: /assets/img/RtM/RtM-05.png
    alt: Patterns
