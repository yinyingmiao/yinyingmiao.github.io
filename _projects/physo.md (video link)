...
title: "PhySo: Fostering Shared Awareness of Office Noise through Data Physicalization"

cover: /assets/img/PhySo_Main.png

project_type: Individual MSc Research Project

publication: "Manuscript as Work-in-Progress under review (collaborated with supervisors: Steven Houben, Hans Brombacher)"
...
gallery:
  - src: /assets/img/PhySo/PhySo-01.png
    alt: design research process

  - src: /assets/img/PhySo/PhySo-02.png
    alt: problem definition and design explorations

  - src: /assets/img/PhySo/PhySo-03.png
    alt: final design, development, and deployment
